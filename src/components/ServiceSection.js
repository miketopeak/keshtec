    ...
    <div className="auto-container">
      <div className="flex flex-wrap -mx-4">
        <div className="w-full md:w-1/2 lg:w-1/3 mb-4 ">
          <div className="service-box flex flex-col h-full bg-white p-6 shadow-lg rounded-lg">
            <h1 className="text-2xl font-bold py-[18px]">Vision</h1>
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 mb-4 ">
          <div className="service-box flex flex-col h-full bg-white p-6 shadow-lg rounded-lg">
            <h1 className="text-2xl font-bold py-[18px]">Mission</h1>
            <div className="text-base text-[#1a1e66] flex-grow">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 mb-4 ">
          <div className="service-box flex flex-col h-full bg-white p-6 shadow-lg rounded-lg">
            <h1 className="text-2xl font-bold py-[18px]">Philosophy</h1>
            <div className="text-base text-[#1a1e66] flex-grow">
